...
<div id="carouselDarkVariant" class="carousel slide carousel-fade carousel-dark" data-mdb-ride="carousel" 
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
        <img src="img/<c:forEach var="imagenPr" items="${imagenPr}">${imagenPr.getCarusel()}</c:forEach>" width="5000" height="200" class="d-block w-100" alt="Motorbike Smoke" />
    ...
    <!-- Single item -->
    <c:forEach var="imagenesCarusel" items="${imagenesCarusel}">
    <div class="carousel-item">
        <img src="img/${imagenesCarusel.getCarusel()}"  width="500" height="200" class="d-block w-100" alt="Mountaintop"/>
      <div class="carousel-caption d-none d-md-block">
     ...
     data-aos-duration="6000" >
                <div class="row " style="padding: 70px 0px">
                    ...
                    <c:forEach var="historia" items="${historia}">
                        ...
                        <input value="dfdscdv<c:forEach var="historia" items="${historia}">
                        ${historia.getCarusel()}
                    </c:forEach>"> 
                    ...
                    <div class="col-md-6">
                        <img 
                        src="img/<c:forEach var="historia" items="${historia}">${historia.getImgHistoria()}</c:forEach>" 
               class="img-fluid" alt="imgencenttro"> 
                    </div>
                </div>
            </div>  
